...
The extension board don't have a 5VDC voltage regulator, it uses the voltage regulator on the Nano Board, and sends that 5VDC to all the 5V pin-header and the MCU.
